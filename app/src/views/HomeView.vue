<template>
<div>
  <h3  style="text-align: center">eStore.se</h3>
  <h1  style="text-align: center">HOMEPAGE</h1>
</div>

<div style="display: flex; justify-content: center; flex-direction: column; gap: 125px; margin-bottom: 50px">
    <!-- Carousel wrapper -->
  <div id="carouselBasicExample" class="carousel slide carousel-fade mt-5" data-mdb-ride="carousel">
    <!-- Indicators -->
